...
def init_env(initialisation = 'uniform'):
    ...
    discrete_os_size = [21] * len(high)
    discrete_os_win_size = (high\
            - low) / discrete_os_size
...
def q_lrn(alpha, gamma, epsilon, e_decay_rate, eps_start, eps_end, episodes,\
    ...
    Q, env, s_obs_high, s_obs_low, n_actions, s_os_size, s_os_win =\
...
def test_qtable(Q, env, n_tests, n_actions, render, s_os_win, s_obs_low, delay=0.1):
